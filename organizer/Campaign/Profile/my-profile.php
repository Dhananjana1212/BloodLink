...
$OrganizerID ='7';
$sql = "SELECT * FROM campaignorganizer Where OrganizerId = $OrganizerID";
...
$OrganizerID = $profileData['OrganizerID'];
...
<html>
  ...
  <body class="ucsc-light-grey">
    ...
    >
      ...
      <div class="ucsc-container ucsc-row">
        ...
        <div class="ucsc-col s8 ucsc-bar">
          <span>Welcome, <strong><?php echo $profileData['Name']; ?></strong> </span
          ><br />
        </div>
      </div>
      <hr />
      ...
      <div class="ucsc-bar-block">
        ...
        >
        <a href="../notifications/notifications.html" class="ucsc-bar-item ucsc-button ucsc-padding"
          ><i class="fa fa-bell fa-fw"></i>  Notifications</a
        >
        <a href="../campaigns/campaigns.html" class="ucsc-bar-item ucsc-button ucsc-padding"
          ><i class="fa fa-calendar-check-o fa-fw"></i>  Publishing</a
        >
    ...
    <div class="ucsc-main" style="margin-left: 300px; margin-top: 43px">
      ...
      <div class="ucsc-container" style="display: flex; align-items: center;  width: 2000px;">
          ...
          <div class="ucsc-row-padding">
              ...
              >
                <div class="ucsc-container">
                  ...
                  <h4 class="ucsc-center"><?php echo $profileData['Name']; ?></h4>
                  <h6 class="ucsc-center"><?php echo $profileData['District']; ?>, Sri Lanka</h6>
                  ...
                  <div class="ucsc-half">
                    ...
                    <p>
                      <i class="fa fa-home fa-fw ucsc-margin-right ucsc-text-theme"></i>
                      <b>Postal Code:</b> 
                      <?php echo $profileData['PostalCode']; ?>
                    </p>
                  </div>
                  ...
                  <div class="ucsc-half">
                    ...
                    <p>
                      ...
                      <b>User ID:</b> <?php echo $profileData['OrganizerID']; ?>
                    </p>
                    <br /><br />
                  </div>                  

                  <button class="ucsc-button ucsc-yellow ucsc-right" style="margin-right:-16px;">
                    <i class="fa fa-trash fa-fw ucsc-margin-right ucsc-text-theme"></i>Delete
                  </button>
                  <a href = "OrgRegisterEdit.php" class="ucsc-button ucsc-green ucsc-right">
