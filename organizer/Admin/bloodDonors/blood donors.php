...
$sql = "SELECT DonorID, FirstName, LastName, Email, Contact, District FROM blooddonor";
...
<html>
  ...
  >
    ...
    >
      <a href="blood donors.php" class="ucsc-bar-item ucsc-button ucsc-padding ucsc-teal"
    ...
    <div class="ucsc-main" style="margin-left: 300px; margin-top: 43px">
      ...
      <header class="ucsc-container" style="padding-top: 22px">
        <h5>
          <b><i class="fa fa-male"></i> Blood Donor Details</b>
        </h5>
      </header>
            ...
            <tr>
              ...
              if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                      ...
                      echo "<td>
                              <a href='/bloodlink/Admin/bloodDonors/RegisterEdit.php?id=".$row["DonorID"]."' class='ucsc-button ucsc-green'>Update</a>
                              <a href='/bloodlink/Admin/bloodDonors/deleteRegister.php?id=".$row["DonorID"]."' class='ucsc-button ucsc-green'>Delete</a>
                          </td>";
                      echo "</tr>";
                  }
              } 
