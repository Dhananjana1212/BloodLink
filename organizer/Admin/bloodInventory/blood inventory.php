...
$sql = "SELECT InventoryManagerID, BloodBankID, FirstName, LastName, Email, Contact FROM inventorymanager";
...
<html>
  ...
  >
    ...
    <div class="ucsc-bar-block">
      ...
      <a href="blood inventory.php" class="ucsc-bar-item ucsc-button ucsc-padding ucsc-teal"
    ...
    <div class="ucsc-main" style="margin-left: 300px; margin-top: 43px">
      ...
      <header class="ucsc-container" style="padding-top: 22px">
        <h5>
          <b><i class="fa fa-user-circle-o"></i> Blood Inventory Manager Details</b>
        </h5>
      </header>
      ...
      <!-- <div class="ucsc-container" style="display: flex"> -->
            ...
            <tr>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . $row["InventoryManagerID"]. "</td>";
                        ...
                        echo "<td>
                                <a href='/bloodlink/Admin/bloodInventory/RegisterEdit.php?id=".$row["InventoryManagerID"]."' class='ucsc-button ucsc-green'>Update</a>
                                <a href='/bloodlink/Admin/bloodInventory/deleteRegister.php?id=".$row["InventoryManagerID"]."' class='ucsc-button ucsc-green'>Delete</a>
                            </td>";
                        echo "</tr>";
                    }
                } 
        ...
        <div class="ucsc-container">
          ...
          <br/>
          <h5 class="ucsc-center"><b>Add New Inventory Manager</b> <i class="fa fa-arrow-down"></i></h5><br/>
