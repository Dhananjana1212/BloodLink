...
$sql = "SELECT OrganizerID, Name, Address, District,Email, Contact FROM campaignorganizer";
  ...
  <body class="ucsc-light-grey">
    ...
    >
      ...
      <div class="ucsc-bar-block">
       ...
       <a href="campaign organizers.php" class="ucsc-bar-item ucsc-button ucsc-padding ucsc-teal"
    ...
    <div class="ucsc-main" style="margin-left: 300px; margin-top: 43px">
      ...
      <header class="ucsc-container" style="padding-top: 22px">
        <h5>
          <b><i class="fa fa-tint"></i> Campaign Organizer Details</b>
        </h5>
      </header>
      ...
      <!-- <div class="ucsc-container" style="display: flex"> -->
            ...
            <tr>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='/bloodlink/Admin/campaignOrg/OrgRegisterEdit.php?id=".$row["OrganizerID"]."' class='ucsc-button ucsc-green'>Update</a>
                                <a href='/bloodlink/Admin/campaignOrg/deleteRegister.php?id=".$row["OrganizerID"]."' class='ucsc-button ucsc-green'>Delete</a>
                            </td>";
                        echo "</tr>";
                    }
                } 
        ...
        <div class="ucsc-container">
          ...
          <br/>
          <h5 class="ucsc-center"><b>Add New Campaign Organizers</b> <i class="fa fa-arrow-down"></i></h5><br/>
          <form class="ucsc-form">
          <a href = "OrgRegister.php" class="ucsc-button ucsc-green">ADD</a>
          </form><br/>
          </div>
