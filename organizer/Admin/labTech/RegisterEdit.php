...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  $sql = "UPDATE sampletester SET FirstName='".$_POST["FirstName"]."', LastName='".$_POST["LastName"]."', Contact=".$_POST['Contact'].", Email='".$_POST["Email"]."' WHERE TesterID=".$_POST["TesterID"]."";
  ...
  $id = $_GET["id"];
  $sql = "SELECT TesterID, FirstName, LastName, Email, Contact FROM sampletester where TesterID=" . $id;
  $result = $conn->query($sql);
  ...
  <div class="wrapper">
    ...
    <div class="form">
      ...
      <form action="" method="POST">
       ...
       <input type="hidden" class="input" name="TesterID" id="TesterID" required value="<?= $row['TesterID'] ?>">  
        <div class="inputfield">
