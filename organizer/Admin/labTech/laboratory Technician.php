...
$sql = "SELECT TesterID, FirstName, LastName, Email, Contact FROM sampletester";
...
<html>
  ...
  >
    ...
    >
      ...
      >
      <a href="laboratory Technician.php" class="ucsc-bar-item ucsc-button ucsc-padding ucsc-teal"
    ...
    <div class="ucsc-main" style="margin-left: 300px; margin-top: 43px">
      ...
      <header class="ucsc-container" style="padding-top: 22px">
        <h5>
          <b><i class="fa fa-flask"></i> Laboratory Technician Details</b>
        </h5>
      </header>
      ...
      <!-- <div class="ucsc-container" style="display: flex"> -->
            ...
            <tr>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='/bloodlink/Admin/labTech/RegisterEdit.php?id=".$row["TesterID"]."' class='ucsc-button ucsc-green'>Update</a>
                                <a href='/bloodlink/Admin/labTech/deleteRegister.php?id=".$row["TesterID"]."' class='ucsc-button ucsc-green'>Delete</a>
                            </td>";
                        echo "</tr>";
                    }
                } 
        ...
        <div class="ucsc-container">
          ...
          <br/>
          <h5 class="ucsc-center"><b>Add New Lab Technician</b> <i class="fa fa-arrow-down"></i></h5><br/>
