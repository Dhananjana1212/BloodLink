...
<html>
  <head>
    ...
    <style>
      ...
      ucsc-bar-item.ucsc-button:hover {
  ...
  <body class="ucsc-light-grey">
    ...
    >
      ...
      <a href="full_blood_packets.html" class="ucsc-bar-item ucsc-button ucsc-padding"><i class="fa fa-tint fa-fw"></i> Full Blood Packets</a>
<a href="rbc.html" class="ucsc-bar-item ucsc-button ucsc-padding"><i class="fa fa-tint fa-fw"></i> RBC</a>
<a href="platelets.html" class="ucsc-bar-item ucsc-button ucsc-padding"><i class="fa fa-tint fa-fw"></i> Platelets</a>
<a href="plasma.html" class="ucsc-bar-item ucsc-button ucsc-padding"><i class="fa fa-tint fa-fw"></i> Plasma</a>
<a href="cryoprecipitate.html" class="ucsc-bar-item ucsc-button ucsc-padding"><i class="fa fa-tint fa-fw"></i> Cryoprecipitate</a>
...
<div class="ucsc-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="ucsc-container">
    <div class="ucsc-section ucsc-bottombar ucsc-padding-16">
      ...
      <button class="ucsc-button ucsc-green"><i class="fa fa-arrow-right ucsc-margin-right"></i>This Month</button>
      <button class="ucsc-button ucsc-green"><i class="fa fa-arrow-right ucsc-margin-right"></i>Last Month</button>
      <button class="ucsc-button ucsc-green"><i class="fa fa-arrow-right ucsc-margin-right"></i>Last 3 Months</button>
    </div>
    </div>
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo '<tr>
                        ...
                        <button class="ucsc-button ucsc-red"><a href="delete.php?deleteid=' . $bloodpacketid . '" class="text-light">Delete</a></button>
                        </td>
                        </tr>';
        }
    }
